...
public:
    ...
    int get_flat_index(int cols, int row, int col) { return calc_flat_index(cols, row, col); }
    std::vector<int> get_neighbors(int rows, int cols, int row, int col) { return get_neighbor_indexs(rows, cols, row, col); }
