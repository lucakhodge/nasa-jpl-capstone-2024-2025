...
int main(int argc, char *argv[])
{
    try
    {
        ...
        {
            const std::pair<std::pair<double, double>, std::pair<double, double>> geoCoordinates = commandLineInterface.getGeoCoordinates(); /* Geospatial double coordinates for transforming. */
        ...
        roverPathLogger->logPath(commandLineInterface.getOutputFilename(), routedPath);
    }
