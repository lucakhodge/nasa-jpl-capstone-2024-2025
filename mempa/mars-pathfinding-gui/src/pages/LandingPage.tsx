    ...
    <div className="w-screen h-screen flex flex-col items-center justify-center gap-6" style={{ backgroundColor: '#D1945A' }}>
      ...
      <div className='max-w-md text-center p-4 bg-black/10 rounded-lg'>
        ...
        <p className='text-black/80 text-sm'>
          MEMPA helps plan optimal rover traversal paths across the Martian terrain by analyzing elevation data and calculating slopes. 
          Upload Mars DEM data, select your start and end coordinates, and discover the safest and most efficient path for your mission with detailed terrain analytics.
        </p>
      </div>
